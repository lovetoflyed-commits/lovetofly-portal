          ...
          <div className="border-t pt-5 mt-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input type="text" className="w-full border rounded px-3 py-2" defaultValue={profile.addressNumber} disabled={isBlocked} readOnly={isBlocked} />
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase mb-1">Complemento</label>
                <input type="text" className="w-full border rounded px-3 py-2" defaultValue={profile.addressComplement} disabled={isBlocked} readOnly={isBlocked} placeholder="Apto, Bloco, etc." />
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase mb-1">Bairro</label>
                <input type="text" className="w-full border rounded px-3 py-2" defaultValue={profile.addressNeighborhood} disabled={isBlocked} readOnly={isBlocked} />
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase mb-1">Cidade</label>
                <input type="text" className="w-full border rounded px-3 py-2" defaultValue={profile.addressCity} disabled={isBlocked} readOnly={isBlocked} />
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase mb-1">Estado</label>
                <input type="text" className="w-full border rounded px-3 py-2" defaultValue={profile.addressState} disabled={isBlocked} readOnly={isBlocked} placeholder="SP" maxLength={2} />
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase mb-1">CEP</label>
                <input type="text" className="w-full border rounded px-3 py-2" defaultValue={profile.addressZip} disabled={isBlocked} readOnly={isBlocked} placeholder="12345-678" />
              </div>
            </div>
            <div className="mt-4">
              <label className="block text-xs font-bold text-slate-400 uppercase mb-1">País</label>
              <input type="text" className="w-full border rounded px-3 py-2" defaultValue={profile.addressCountry} disabled={isBlocked} readOnly={isBlocked} placeholder="Brasil" />
            </div>
          </div>
