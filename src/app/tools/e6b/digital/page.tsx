      ...
      {user ? (
        <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                {[
                  ...
                  { name: 'CFI Academy Brasil', city: 'Rio de Janeiro', link: '#', badge: '/LOGOS_LTF/Badge_MLTE.png' },
                ].map((a, i) => (
          ...
          <section className="mt-8">
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border border-slate-200 rounded-lg p-4">
                <div className="font-bold text-slate-800">Manual E6B (PDF)</div>
                <p className="text-sm text-slate-600">Guia completo de uso da calculadora E6B.</p>
                <a href="#" className="text-blue-700 text-sm mt-2 inline-block">Baixar PDF</a>
              </div>
              <div className="border border-slate-200 rounded-lg p-4">
                <div className="font-bold text-slate-800">Vídeo Aula: TAS e Mach</div>
                <p className="text-sm text-slate-600">Conceitos e aplicações práticas.</p>
          ...
          <section className="mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[ 'Widget METAR', 'Planner de Descida', 'Weight & Balance' ].map((t, i) => (
        ...
        <div className="max-w-3xl mx-auto px-4 py-16">
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-slate-200 text-center">
            ...
            <p className="text-slate-600 mb-6">Faça login para usar o E6B Digital.</p>
