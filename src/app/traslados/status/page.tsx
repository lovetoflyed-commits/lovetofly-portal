...
type TrasladosStatusMode = 'portal' | 'admin';

export default function TrasladosStatusPage({ mode = 'portal' }: { mode?: TrasladosStatusMode }) {
    ...
    return (
        <AuthGuard>
            <div className={isAdmin ? 'min-h-screen bg-gray-50 py-8' : 'flex min-h-screen bg-gray-50'}>
                {!isAdmin && <Sidebar />}
                <div className={isAdmin ? 'max-w-7xl mx-auto px-4' : 'flex-1 flex flex-col'}>
                    ...
                    {isAdmin && (
                        <div className="mb-8">
                            ...
                            <h1 className="mt-3 text-3xl font-black text-blue-900">Status da Operacao</h1>
                            <p className="mt-2 text-sm text-slate-600">Atualize e acompanhe o andamento dos traslados.</p>
